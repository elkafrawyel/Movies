...
public class VolleySingleton {
    ...
    private final static long CacheExpired = 2 * 24 * 60 * 60 * 1000;
    ...
    StringRequest makeStringResponse(final String url, final HashMap<String, String> map, final VolleyCallback callback, final JsonVolleyCallbackError errorCallback) {
